...
export const en = {
  ...
  'form.title': 'Title',
  'form.titlePlaceholder': 'What needs doing? (required)',
  'form.project': 'Project',
  'form.projectPlaceholder': 'Pick an existing project or type a new name (empty = uncategorized)',
  'form.priority': 'Priority',
  'form.priorityDefault': 'Default (none)',
  'form.priorityHigh': 'High',
  'form.priorityNormal': 'Normal',
  'form.priorityLow': 'Low',
  'form.due': 'Due',
  'form.duePlaceholder': 'tomorrow 3pm / Friday / 2026-08-26 (empty = today 22:00)',
  ...
  'cmd.newProjectExists': 'A note with this name already exists: {name}.md',
  'cmd.newProjectDone': 'Project note created: {name}',
  'cmd.newProjectFailed': 'Failed to create project: {err}',
  'cmd.newProjectNavMissing': 'Nav not registered: {path} missing or has no standalone-projects line',
  'cmd.open': 'Open',
  ...
  'settings.projectsFolderDesc':
    'Vault-relative folder where the 新建项目 (New project) command creates project notes. Empty = vault root. No trailing slash.',
  'settings.dashboardFile': 'Dashboard file',
  'settings.dashboardFileDesc':
    'Vault-relative note that receives the new-project nav registration (needs a line starting with 独立项目). Empty = create notes without registering.',
