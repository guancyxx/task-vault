...
export const zh: Record<keyof typeof en, string> = {
  ...
  'cmd.newProject': '新建项目',
  'form.title': '标题',
  'form.titlePlaceholder': '要做什么？（必填）',
  'form.project': '项目',
  'form.projectPlaceholder': '选择已有项目或输入新名（留空 = _未分类）',
  'form.priority': '优先级',
  'form.priorityDefault': '默认（无）',
  'form.priorityHigh': '高',
  'form.priorityNormal': '中',
  'form.priorityLow': '低',
  'form.due': '到期',
  'form.duePlaceholder': '明天3点 / 后天 / 周五 / 2026-08-26（留空 = 今天 22:00）',
  ...
  'cmd.newProjectExists': '已存在同名笔记：{name}.md',
  'cmd.newProjectDone': '已创建项目笔记：{name}',
  'cmd.newProjectFailed': '创建项目失败：{err}',
  'cmd.newProjectNavMissing': '未登记导航：{path} 不存在或缺少「独立项目」行',
  'cmd.open': '打开',
  ...
  'settings.projectsFolder': '项目文件夹',
  'settings.projectsFolderDesc':
    '「新建项目」命令创建项目笔记的库内相对文件夹（如 01 Projects）。留空 = 库根目录。不带首尾斜杠。',
  'settings.dashboardFile': 'Dashboard 文件',
  'settings.dashboardFileDesc':
    '「新建项目」登记导航的库内相对笔记（需含「独立项目」起始行，如 Dashboard.md）。留空 = 只建笔记不登记。',
  ...
  'agenda.empty': '今天没有日程',
  'agenda.allDay': '全天',
  'agenda.doneGroup': '今日完结',
  'agenda.fullCalendar': '🗓 完整日历',
